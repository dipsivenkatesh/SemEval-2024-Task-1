...
def get_similarity_scores_openai(lang, model_id):
    ...
    def get_embedded_lists(model_id):
        s1_list = []
        s2_list = []
    ...
    s1_embedded_list_obj, s2_embedded_list_obj = get_embedded_lists(model_id)
    s1_embedded_list = [obj.get("embedding") for obj in s1_embedded_list_obj.get("data")]
    s2_embedded_list = [obj.get("embedding") for obj in s2_embedded_list_obj.get("data")]
    s_sim_pred_scores = []
